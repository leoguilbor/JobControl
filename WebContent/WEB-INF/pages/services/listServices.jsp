...
<body onload='listEntity("Servicem");'>
...
<div class="w3-content">
	...
	<p> <button onclick="showForm(document.getElementById('servicem'));" class="w3-btn">	&#127381; Cadastrar</button>  </p>	
	<p> <button onclick="listEntity('service');" class="w3-btn">	&#8635;</button>  </p>

        <table id="table_servicem" class="w3-table-all w3-card-4 w3-responsive">
        <thead>
            <tr class="w3-green" >
