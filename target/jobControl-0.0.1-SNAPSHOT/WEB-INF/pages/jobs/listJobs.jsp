	...
	<p> <button onclick="listEntity('Job');" class="w3-btn">	&#8635;</button>  </p>
        ...
        <thead>
            <tr class="w3-green" >
                ...
                <th id="service.name"><input type="text" class="w3-input w3-green w3-threequarter" oninput="w3.filterHTML('#table_client', '.item', this.value)" placeholder="Serviço &#128269;" />	<a class="w3-quarter w3-center w3-padding" href=# onclick="w3.sortHTML('#table_client','.item', 'td:nth-child(3)')">&#8661;</a></th>
